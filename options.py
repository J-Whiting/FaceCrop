...
class Options:
    def __init__(self):
        ...
        self.parser.add_argument("--video_file", type=str, default=r"toy-story.mp4", help="filename of video file")
        self.parser.add_argument("--classifier_file", type=str, default=r"classifier/woody.xml",
